...
client.once('ready', () => {
    ...
    client.user.setActivity(`${config.prefix}help • ${client.user.username.toUpperCase()}`, { type: "STREAMING",url: "https://www.twitch.tv/discord" }); // Set the bot's activity status
